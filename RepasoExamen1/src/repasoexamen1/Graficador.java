        ...
        try {
            ...
            while ((linea = leer.readLine()) != null) {
                ...
                if (registro[0].equals("Circulo")) {
                    ...
                    String puntosV2 = registro[3];
                    String[] punto2 = puntosV1.split(",");
                    int xv2 = Integer.parseInt(punto2[0]);
                    int yv2 = Integer.parseInt(punto2[1]);
                    String puntosV3 = registro[3];
                    String[] punto3 = puntosV1.split(",");
                    int xv3 = Integer.parseInt(punto3[0]);
                    int yv3 = Integer.parseInt(punto3[1]);
                    String puntosV4 = registro[3];
                    String[] punto4 = puntosV1.split(",");
                    int xv4 = Integer.parseInt(punto4[0]);
                    int yv4 = Integer.parseInt(punto4[1]);
